/**
 * React plugin template hook generator.
 *
 * Keep this wrapper intentionally thin so new renderer APIs exposed from
 * preload become available to template users without hand-maintaining a
 * second mirror here.
 */

export function buildUseMulby() {
